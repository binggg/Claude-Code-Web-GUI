// Language configuration for React version - complete translations from original
export const LANGUAGES = {
    en: {
        ...
        gistImportDescription2: 'Enter a GitHub Gist URL to view shared session content. Supports both full URLs and Gist IDs.',
        ...
        smartDescription: '🚀 Just witnessed an epic AI coding session! 🤖✨ Check out how Claude tackled this programming challenge',
        sessionSharing: '🤖 "{{content}}" - When AI meets code, magic happens! 🪄 Dive into this fascinating Claude Code session',
        sessionTitle: '{{title}} - Claude Code Session 📊',
        projectInfo2: '🏗️ Project: {{project}} | ⏰ Time: {{time}}',
        gistCreationInfo: '📅 Shared: {{date}} | 📋 Format: {{format}}',
        ...
        retryLoading: 'Retry',
        closeError: 'Close',
        copySessionData: 'Copy Session Data',
        copySessionDescription: 'Copy complete session data for importing on other devices.',
        copySessionToClipboard: 'Copy to Clipboard',
        copied: 'Copied',
        copyFailed: 'Copy Failed',
        shareError: 'Share Error',
        gistFeatureNotImplemented: 'Gist sharing feature not yet implemented, please use copy function.',
        errors: {
    ...
    zh: {
        ...
        gistImportDescription2: '输入他人分享的GitHub Gist地址，即可查看其会话内容。支持完整URL或Gist ID。',
        ...
        smartDescription: '🚀 见证了一场史诗级的AI编程对决！🤖✨ 看看Claude是如何解决这个编程难题的',
        sessionSharing: '🤖 "{{content}}" - 当AI遇上代码，魔法就会发生！🪄 深入探索这个精彩的Claude Code会话',
        sessionTitle: '{{title}} - Claude Code 会话 📊',
        projectInfo2: '🏗️ 项目: {{project}} | ⏰ 时间: {{time}}',
        gistCreationInfo: '📅 分享于: {{date}} | 📋 格式: {{format}}',
        ...
        retryLoading: '重试',
        closeError: '关闭',
        copySessionData: '复制会话数据',
        copySessionDescription: '复制完整的会话数据，可以在其他设备上导入查看。',
        copySessionToClipboard: '复制到剪贴板',
        copied: '已复制',
        copyFailed: '复制失败',
        shareError: '分享失败',
        gistFeatureNotImplemented: 'Gist分享功能尚未实现，请使用复制功能。',
        errors: {
